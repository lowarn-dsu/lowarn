...
-- | A type class that allows @'RuntimeData' a@ to be set in certain modules.
-- Instances of this type class are generated by the injection plugin in modules
...
-- | A type class that allows @'RuntimeData' a@ to be accessed in certain
-- modules. Instances of this type class are generated by the injection plugin.
